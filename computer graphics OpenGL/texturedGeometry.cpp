...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(1.0f, 1.0f, 0.0f, 1.0f) ); //index 0 
   colors->push_back(osg::Vec4(0.0f, 1.0f, 1.0f, 1.0f) ); //index 1 
   colors->push_back(osg::Vec4(1.0f, 0.0f, 1.0f, 1.0f) ); //index 2 
   colors->push_back(osg::Vec4(0.3f, 0.5f, 0.6f, 1.0f) ); //index 3 
